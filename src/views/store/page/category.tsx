...
import { DataTableColumn, MenuOption, NA, NButton, NCard, NDataTable, NDivider, NForm, NFormItem, NInput, NSpace } from 'naive-ui';
    ...
    return (
      <SpaceView style={{paddingTop: 0}}>
        <NSpace vertical size={[0, 16]}>
          <StoreTabs defaultValue='category' />
          <NSpace>
            <NButton type='primary'>新建微页面分类</NButton>
          </NSpace>
